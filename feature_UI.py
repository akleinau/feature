...
# parallel plot
parallel_plot = pn.bind(parallel_plot, ds.clustered_data, ds.cur_feature, ds.all_selected_cols,
                        ds.item_prediction, ds.item_data, ds.chart_type)

# cluster bar plot
cluster_plot = pn.bind(cluster_bar_plot, ds.clustered_data, ds.cur_feature, ds.all_selected_cols,
                       ds.item_prediction,ds.x, ds.chart_type, ds.prob_wo_selected_cols)
...
rendered_plot = pn.bind(render_plot, ds.graph_type, dep_plot, cluster_plot, parallel_plot, [ds.cur_feature])
